        ...
        const risp = 
      {
        events: docs.map(doc => {
          return {
            ...
            request: {
              type: "GET",
              url: "https://http://hypermedia19.herokuapp.com/event/" + doc._id
            }
          };
        })
      };
        ...
        .then(result => {
          res.status(201).json(JSON.stringify({
            ...
            createdArtist: {
              ...
              request: {
                type: "GET",
                url: "https://http://hypermedia19.herokuapp.com/event/" + result._id
              } 
            }
          }));
        })
    ...
    .then(doc => {
      if (doc) {
        res.status(200).json(JSON.stringify({
          ...
          request: {
            type: "GET",
            url: "https://http://hypermedia19.herokuapp.com/event/"
          }
        }));
      } else {
        res
